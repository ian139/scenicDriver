...
- [x] Corrected full 2,256-case Vast benchmark from `49b10789` — r15 completed and published on offer `40429508` (256 effective CPU cores, 1,031,851 MiB RAM, 2 workers, group size 64). It persisted all 2,256 canonical cases and passed every completed-route correctness invariant, including `q0_fastest: pass=1563`, baseline presence, duration-cap, highway, objective, route-metric, certification, and diagnostic consistency. Results: 1,563 completed, 497 timeouts, 196 legitimate no-route results; fixed-denominator median/p95 `6,418.755/10,915.547 ms`, and 1,758 cases (77.93%) under 10 seconds. Compared with corrected r8, under-10 completion rose 16.98 percentage points and p95 improved 6.82%, but fixed-denominator median worsened 7.85%; this is not a complete latency-SLA gate.
...
- [ ] Fixed-denominator latency SLA/profile remains unresolved. The r15 result is materially better on under-10 completion but is not a median win; the same-CPU r16 comparison confirms no fixed-denominator median/p95 win. Do not claim CCH/MLD justification or acceptance from these runs alone; no further Vast run was launched in this wave.
