...
def parse_args() -> argparse.Namespace:
    ...
    init.add_argument("--image", help="Container image to pull/run; defaults to ian139/scenicdriver-remote-training:latest")
    ...
    init.add_argument("--smoke-command", default="python scripts/modeling/train_regression_baseline.py --help")
