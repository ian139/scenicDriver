...
- In progress: regression training, NAIP ingestion, routing prototype.
...
4. Train multitask regression/classification model.
5. Build a road graph and score edges with scenic tiles.
